...
if USE_MYSQL:
    ...
    # SQLite — hech qanday o'rnatish shart emas
    DATABASES = {
        'default': {
...
ADMIN_SITE_HEADER  = "Mehmonxona Boshqaruv Tizimi"
ADMIN_SITE_TITLE   = "Hotel Admin"
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PAGINATION_CLASS': 'hotel_project.pagination.FlexiblePageNumberPagination',
    'PAGE_SIZE': 20,
    'DEFAULT_RENDERER_CLASSES': (
        'rest_framework.renderers.JSONRenderer',
        'rest_framework.renderers.BrowsableAPIRenderer',  # Brauzerda ko'rish uchun
    ),
}
...
# CORS — allow React frontend (all localhost ports)
